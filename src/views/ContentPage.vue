...
<template>
  <div class="content-page">
    ...
    <nav class="section-nav">
      <div class="nav-items">
        <button @click="activeSection = 'overview'" :class="{ active: activeSection === 'overview' }" class="nav-item">
          Chapter Overview
        </button>
        ...
        <button @click="activeSection = 'heritage'" :class="{ active: activeSection === 'heritage' }" class="nav-item">
          Mathematical Heritage
        </button>
        <button @click="activeSection = 'visual'" :class="{ active: activeSection === 'visual' }" class="nav-item">
          Visual Resources
        </button>
        ...
        <div class="sidebar-section">
          ...
          <nav class="topics-nav">
            <button v-for="(section, index) in chapterData.sections" :key="'topic-' + index"
              @click="scrollToSection(index)" :class="{ active: activeTopicIndex === index }" class="topic-item">
              {{ section.title }}
            </button>
          </nav>
        </div>
...
export default {
  ...
  this.selectedPersonality = personality;
    ...
    scrollToSection(index) {
      ...
      this.activeSection = 'overview'; // Switch to overview section
      this.$nextTick(() => {
